...
const initialRepos: RepositoryItem[] = [
  {
    ...
    status: 'active',
    description: 'AI-powered code review and static analysis platform',
  },
  {
    id: 'repo-2',
    ...
    status: 'active',
    description: 'FastAPI core backend for scanning and review services',
  },
  {
    id: 'repo-3',
    name: 'web-dashboard',
    ...
    status: 'active',
    description: 'Frontend user interface web application',
  },
];
...
export function RepositoriesView({ onShowToast }: RepositoriesViewProps) {
  ...
  const handleConnectRepo = () => {
    ...
    const newRepo: RepositoryItem = {
      ...
      owner: newRepoName.includes('/') ? newRepoName.split('/')[0] : 'aannmaryanto',
      language: 'typescript',
      defaultBranch: 'main',
      isPrivate: true,
      lastScan: 'Just now',
